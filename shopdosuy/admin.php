...
Bảnh.2hand
      ...
      <div class="logo">
        ...
        <div class="menu">
            ...
            <div class="danhmuc">
        <form action="formthemsp.php">
         <button type="submit" name="themsp">THÊM SẢN PHẨM</button>
            </form>
<form action="formdskh.php" >
<button type="submit"><b>KHÁCH HÀNG</b></button>
</form>
<form action="dsdhchoduyet.php" >
<button type="submit"><b>ĐƠN HÀNG</b></button>
</form>
<form action="formdsdonhang.php" >
<button type="submit"><b>LỊCH SỬ GIAO DỊCH</b></button>
</form>
</div>        
<div class="minimenu2"><div class="menu-search">
                <form id="tksp" action="formtksp.php" method="post" >
        ...
        <form action="tkadmin.php">
         <button type="submit" name="themsp" style=" font-size: 25px;color:black; background-color: white; border: none; margin-left: 30px"><i class="fa-solid fa-user"></i></button>
            </form>
        </div>
    </div>
    ...
    die("Kết nối đến cơ sở dữ liệu thất bại: " . $conn->connect_error);
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<a href='chitietsp.php?id=" . $row['id'] . "'><img src='" . $row['hinhanh0'] . "' alt='Hình ảnh sản phẩm' > </a>";
